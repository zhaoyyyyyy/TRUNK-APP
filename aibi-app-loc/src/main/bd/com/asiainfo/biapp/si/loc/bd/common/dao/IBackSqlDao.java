...
public interface IBackSqlDao {
     ...
     * @return
     */
    public boolean createVerticalTable(String tableName,String columnName,String partionDate,String partionID) throws SqlRunException;
     ...
     * @return
     */
    public boolean loadDataToTabByPartion(String sql, String tableName,String partionDate,String partionID) throws SqlRunException;
