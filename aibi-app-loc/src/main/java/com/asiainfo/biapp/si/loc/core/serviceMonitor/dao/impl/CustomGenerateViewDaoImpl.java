...
public class CustomGenerateViewDaoImpl extends BaseDaoImpl<CustomGenerateView, String> implements ICustomGenerateViewDao{
    ...
    @Override
    public Page<CustomGenerateView> queryCustomGenerateViewPage(Page<CustomGenerateView> page, String configId) {
        Map<String, Object> params = new HashMap<>();
        StringBuffer hqls = new StringBuffer("from CustomGenerateView s where s.labelId in(select a.labelId from LabelInfo a where a.configId= :configId) ");
