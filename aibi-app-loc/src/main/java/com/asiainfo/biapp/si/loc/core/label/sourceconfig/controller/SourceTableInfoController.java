...
public class SourceTableInfoController extends BaseController<SourceTableInfo> {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "sourceFileName", value = "指标源表文件名", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "sourceTableName", value = "指标源表表名", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "tableSchema", value = "表名SCHEMA", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "sourceTableCnName", value = "指标源表中文名", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "sourceTableType", value = "指标源表类型", required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "tableSuffix", value = "表/文件后缀日期", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "readCycle", value = "读取周期", required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "keyType", value = "标签主键标识类型", required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "idType", value = "来源主键标识类型", required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "idColumn", value = "来源主键字段名", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "idDataType", value = "来源主键数据类型", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "columnCaliber", value = "业务口径", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "dataSourceId", value = "数据源ID", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "dataSourceType", value = "数据源类型", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "dataExtractionType", value = "数据抽取方式", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "dateColumnName", value = "日期分区字段", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "whereSql", value = "过滤条件", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "statusId", value = "状态", required = true, paramType = "query", dataType = "int") })
