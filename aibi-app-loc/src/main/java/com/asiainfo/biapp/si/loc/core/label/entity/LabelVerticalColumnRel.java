...
public class LabelVerticalColumnRel extends BaseEntity {
	...
	@EmbeddedId
	private LabelVerticalColumnRelId labelVerticalColumnRelId;
	...
	public LabelVerticalColumnRelId getLabelVerticalColumnRelId() {
		return labelVerticalColumnRelId;
	}

	public void setLabelVerticalColumnRelId(LabelVerticalColumnRelId labelVerticalColumnRelId) {
		this.labelVerticalColumnRelId = labelVerticalColumnRelId;
	}
